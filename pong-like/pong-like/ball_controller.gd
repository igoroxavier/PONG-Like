...
func atualizar_placar() -> void:
	...
	if GameController.player1_points >= 5:
		finalizar_jogo("JOGADOR 1 VENCEU")
	elif GameController.player2_points >= 5:
